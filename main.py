...
if __name__ == '__main__':
    ...
    # load dataset
    train_dataset = SapienArtSegDataset_nerfacc(
    ...
    for step in train_bar:
        ...
        train_bar.set_description(f'trainig at step: {step}, current psnr: {psnr:.2f}, cur batch size: {cur_bs/1024:.1f}k')
        if step > 0: 
